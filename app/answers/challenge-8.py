# === ANSWER KEY — Challenge 8 (teacher reference; students should NOT see this) ===
# Same as app/starter-code/challenge-8.py with tuned colour thresholds filled in.
...
COLOR_PAUSE_TIME = 2  # seconds to pause when a red/green marker is found

# Colour thresholds — set on the robot so classify_color() can use them.
my_robot.color_min_clear = 180  # plain floor reads clear ~120, markers ~280+
my_robot.color_red_ratio = 0.55  # red fraction r/(r+g+b) needed to call it RED
my_robot.color_green_ratio = 0.55  # green fraction g/(r+g+b) needed to call it GREEN
my_robot.color_silver_clear = 500  # silver is bright (clear ~620) AND balanced
