# === ANSWER KEY — Challenge 3 (teacher reference; students should NOT see this) ===
# Same as app/starter-code/challenge-3.py with tuned values filled in.

# Challenge 3: Wall Follow — Full PID
# Add an Integral term so the robot holds the wall around the L corner.
# Guide: docs.html?doc=Challenge_3
